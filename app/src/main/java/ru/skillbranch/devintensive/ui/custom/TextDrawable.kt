...
class TextDrawable private constructor(builder: Builder) : ShapeDrawable() {

    companion object {
        private const val SHADE_FACTOR = 1
    ...
    private fun getDarkerShade(color: Int): Int {
        return Color.rgb(
            ...
            (SHADE_FACTOR * Color.green(color)),
            (SHADE_FACTOR * Color.blue(color))
        )
    }
